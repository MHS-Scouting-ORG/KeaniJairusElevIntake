...
public class IntakeWithStickCmd extends Command {
  ...
  public IntakeWithStickCmd(UnderIntakeSubsystem uSubs, DoubleSupplier newDoubleSuppY, DoubleSupplier newDoubleSuppX) {
    u_Subsystem = uSubs;
    timer = new Timer();
